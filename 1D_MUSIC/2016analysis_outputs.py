...
N_Bkg               = 2791    #1Ele_1Muon_1MET 2017UL 6076  2016 2791  |  
...
plot_1distribution(tau, df=TAU_df, xmin=0, xmax=3500, ymax=0.14, nbins=15, wc= str(TAU_wc), label=r'$\tau(D)$, '+label, save=True, save_path=out_folder, file_name='TAU')
